...
<html>
	<head>
		...
		var host = "<%=basePath%>manager/";
		$(function() {
			loadSpecificPage("operator");
		...
		<div style="height: 100%; margin: 80px 0 80px 20px;">
			...
			<div class="tabbable tabs-left">
				<ul class="nav nav-tabs nav-pills col-md-2" style="padding-right: 0; margin-right: 0;">
					<li class="active">
						<a href="#operator" title="operator" data-toggle="tab">
					...
					<li>
						<a href="#operationlog" title="operationlog" data-toggle="tab">
							操作记录<span class="pull-right"><i class="icon-chevron-right"></i></span>
						</a>
					</li>
					<li>
				...
				<div class="tab-content col-md-10">
					...
					<div class="tab-pane" id="operationlog">
						<!-- 加载操作记录模块 -->
					</div>
