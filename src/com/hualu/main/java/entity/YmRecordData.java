...
/**
 * YmRecordData entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "ym_record_data", catalog = "hualu")
public class YmRecordData implements java.io.Serializable {
	...
	/** full constructor */
	public YmRecordData(Integer userid, String dsn, String dstr,
